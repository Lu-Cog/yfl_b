		...
		<view class="product-window"
			...
			<view class="productWinList">
				<view class="item" v-for="(item, indexw) in attr.productAttr" :key="indexw">
					...
					<view class="listn acea-row row-middle">
						<button class="itemn" :class="item.index === itemn.attr ? 'on' : ''"
			...
			<view class="cart acea-row">
				...
				<view class="carnum acea-row row-left">
					...
					<view class='item num'>
						<input type="number" disabled="true" v-model="attr.productSelect.cart_num"
							data-name="productSelect.cart_num" @input="bindCode(attr.productSelect.cart_num)"></input>
					</view>
	              ...
	              attr.productSelect.cart_num >= attr.productSelect.stock || destri
					...
					<view v-else class='item plus'
						:class='(attr.productSelect.cart_num >= attr.productSelect.quota_show) || (attr.productSelect.cart_num >= attr.productSelect.product_stock)? "on":""'
						@click='CartNumAdd'>+</view>
				</view>
			</view>
			<view class="joinBnt2 bg-color" v-if="attr.now_buy==1" @tap="goCat">立即购买</view>
			<view class="joinBnt2 bg-color" v-else-if="isAddCart" @tap="joinCart()">加购物车</view>
...
<script>
	export default {
		...
		methods: {
			joinCart: function() {
				console.log("buyProId=" + this.attr.now_buy);
