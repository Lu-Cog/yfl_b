			...
			<view class="main" v-if="spikeList.length > 0">
				<view class="seckill-count">
					<view class="spike-bd">
						...
						<navigator url="/pages/activity/goods_seckill/index" class="more-btn" hover-class="none">更多<text
								class="iconfont icon-jiantou" hover-class='none'></text></navigator>
					</view>
					<view class="spike-wrapper">
						<scroll-view scroll-x="true" style="white-space: nowrap; display: flex" show-scrollbar="false">
							<navigator class="spike-item" v-for="(item,index) in spikeList" :key="index"
					...
					<view>
						...
						<block>
							<view class="spike-bd">
								...
								<navigator url="/pages/activity/liveBroadcast/index" class="more-btn"
									hover-class="none">更多<text class="iconfont icon-jiantou" hover-class='none'></text>
								</navigator>
							</view>
			...
			<view class="main" v-if="presellList.length > 0">
				<view class="presell-count">
					<view class="spike-bd title-bd">
						...
						<navigator url="/pages/activity/presell/index" class="more-btn" hover-class="none">更多<text
								class="iconfont icon-jiantou" hover-class='none'></text></navigator>
					</view>
					<view class="wapper_count">
						<view class="spike-wrapper">
							<scroll-view scroll-x="true" style="white-space: nowrap; display: flex"
								...
								<navigator class="spike-item presell-item" v-for="(item,index) in presellList"
									:key="index"
			...
			<view class="main" v-if="assistList.length > 0">
				<view class="assist-count">
					<view class="spike-bd">
						...
						<navigator url="/pages/activity/assist/index" class="more-btn" hover-class="none">更多<text
								class="iconfont icon-jiantou" hover-class='none'></text></navigator>
					</view>
					<view class="wapper_count">
						<view class="spike-wrapper">
							<scroll-view scroll-x="true" style="white-space: nowrap; display: flex"
								show-scrollbar="false">
								<view class="spike-item assist-item" v-for="(item,index) in assistList" :key="index"
									...
									<view class="assist-info">
										<view class="price-box presell-price">
											...
											<text class="price"><text
													class="assist_price">助力价</text><text>￥</text>{{item.assistSku[0].assist_price}}</text>
										</view>
			...
			<block v-if="sortProduct.length>0">
				<view class='list acea-row row-between-wrapper'>
					<navigator :url="`/pages/goods_details/index?id=${item.product_id}`" class='item' hover-class='none'
						...
						<view class='text'>
							<view class='name line1'><text v-if="item.merchant.is_trader"
									class="font-bg-red">自营</text>{{item.store_name}}</view>
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			Promise.all([this.getIndexConfig(), this.storeMerchant(), this.get_host_product(), this.getSpeckillCutTime(),
