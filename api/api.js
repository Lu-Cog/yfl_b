...
export function saveInfo(id,data){
  return request.post("user/save_info/"+id,data,{ noAuth : true});
}
/**
 * 获取主页数据 无需授权
*/
export function getIndexData(id){
	console.log(id,'id');
  // let mer_id = getApp().globalData.userTypeId;
  return request.get("store/merchant/bhome/"+id,{},{ noAuth : true});
}
 ...
 * 案例列表
 */
export function getCasesList(id,data) {
  return request.get('article/cases/mlst/'+id, data, { noAuth: true });
}

/**
 * 案例编辑
 */
export function getCasesSave(id,data) {
  return request.post('article/cases/save/'+id, data, { noAuth: true });
}

/**
 * 删除案例
 */
export function getCasesDelete(mid,id) {
  return request.post('article/cases/delete/'+mid+"/"+id, {}, { noAuth: true });
}
 ...
 * frist
 */
export function getFirstImg() {
  return request.get('store/merchant/first',{},{noAuth:true});
}

/**
 * 档案列表
 */
export function getArchivesList(id,data) {
  return request.get('user/archives/list/'+id,data,{noAuth:true});
}
 ...
 * 档案详情
 */
export function getArchivesDetail(id,data) {
  return request.get('user/archives/detail/'+id,data,{noAuth:true});
}

/**
 * 档案修改
 */
export function getArchivesSave(id,data) {
  return request.post('user/archives/save/'+id,data,{noAuth:true});
}

/**
 * 
 */
export function getBroadcastTj(data) {
  return request.get('broadcast/statistics',data,{noAuth:true});
}
